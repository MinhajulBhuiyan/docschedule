...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        // Extract data from req.body (works with FormData)
        ...
        if (typeof address === 'string') {
            try {
                ...
                console.log('Address parsing failed, using as string:', e.message);
        ...
        if (password.length < 6) {
            return res.json({ success: false, message: "Please enter a strong password (min 6 characters)" })
        }
