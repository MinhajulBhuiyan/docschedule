            ...
            <div className="bg-white rounded-xl shadow-lg p-4 sticky top-20">
              ...
              <div className="grid grid-cols-2 gap-1 mb-3">
                <motion.div 
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ delay: 0.1 }}
                  className="bg-gradient-to-br from-blue-50 to-blue-100 rounded p-1.5 border border-blue-200"
                >
                  <div className="text-center">
                    <div className="w-5 h-5 bg-blue-500 rounded-sm flex items-center justify-center mx-auto mb-1">
                      <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                    </div>
                    <p className="text-base font-bold text-blue-700">{doctors.length}</p>
                    <p className="text-xs text-blue-600 font-medium leading-tight">Total Doctors</p>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ delay: 0.2 }}
                  className="bg-gradient-to-br from-green-50 to-green-100 rounded p-1.5 border border-green-200"
                >
                  <div className="text-center">
                    <div className="w-5 h-5 bg-green-500 rounded-sm flex items-center justify-center mx-auto mb-1">
                      <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-xs text-green-600 font-medium leading-tight">Available Now</p>
                  </div>
                </motion.div>
              </div>

              {/* Speciality Breakdown - More Compact */}
              <div className="mb-4">
                ...
                <div className="space-y-1">
                  {categories.map((cat, index) => {
                    const count = doctors.filter(doc => matchesCategory(doc.speciality, cat.name) || doc.speciality === cat.name).length;
                    ...
                    return count > 0 && (
                      <motion.div 
                        ...
                        className="flex items-center justify-between p-2 bg-gray-50 rounded-md border border-gray-100 hover:border-gray-200 hover:bg-gray-100 transition-all duration-200"
                      >
              ...
              {/* Current Filter Stats - More Compact */}
              {(selectedCategory || searchTerm || filterDoc.length !== doctors.length) && (
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-3 border border-indigo-100 mb-3">
                  <h4 className="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-sm font-bold text-indigo-600">{filterDoc.length}</span>
                  </div>
                  {selectedCategory && (
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-gray-600">Category:</span>
                      <span className="text-xs font-semibold text-indigo-700">{selectedCategory}</span>
                    </div>
                  )}
                  {searchTerm && (
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-600">Search:</span>
                      <span className="text-xs font-semibold text-indigo-700">"{searchTerm}"</span>
                    </div>
                  )}
                </div>
              )}
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white text-xs font-medium py-2 px-3 rounded-md transition-all duration-300 shadow-sm"
                >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-700 text-xs font-medium py-2 px-3 rounded-md transition-all duration-300 border border-gray-200"
                >
                  <span className="flex items-center justify-center gap-1">
                    {viewMode === 'grid' ? (
                      <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
