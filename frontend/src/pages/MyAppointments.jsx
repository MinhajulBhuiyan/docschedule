  ...
  <div>
    ...
    {appointments.length === 0 ? (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-5xl font-semibold text-gray-700 mb-2">Oops! No appointments yet</h2>
        <p className="text-gray-500 mb-6">You haven't booked any appointments. Book now and consult a doctor.</p>
        <button
          onClick={() => window.location.href = "http://localhost:5173/#speciality"}
          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-medium shadow-lg transition-all duration-300"
        >
          See the Doctors
        </button>
      </div>
