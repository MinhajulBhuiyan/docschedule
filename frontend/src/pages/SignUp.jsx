...
const SignUp = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50 flex items-start justify-center pt-2 px-4 pb-4'>
      <div className='w-full max-w-md'>
        <div className='bg-white rounded-lg shadow-md p-8'>
          <h2 className='text-2xl font-bold text-gray-900 text-center mb-2'>Create Account</h2>
          <p className='text-gray-600 text-center mb-6'>Join us to book appointments with top doctors</p>
          ...
          <p className='text-center text-gray-600 mt-6'>
            ...
            <Link to='/login' className='text-[#155af9] font-medium hover:underline'>
              Sign in
            </Link>
          </p>
        </div>
